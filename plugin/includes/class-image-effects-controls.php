		...
		$element->add_control(
			...
			[
				...
				'options'            => [
					...
					'slide-overlay'     => esc_html__( 'Slide Color Overlay', 'aurora-for-elementor' ),
					'3d-tilt'           => esc_html__( 'Interactive 3D Tilt', 'aurora-for-elementor' ),
					'rgb-split'         => esc_html__( 'Chromatic RGB Split', 'aurora-for-elementor' ),
					'liquid-warp'       => esc_html__( 'Liquid Warp Distortion', 'aurora-for-elementor' ),
