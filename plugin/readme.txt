...
* Animate Children Elements: fixed the module being unavailable in the Light (no-GSAP) build, even though it dropped its GSAP dependency back in 0.3.0.
...
= 0.3.0 =
* Animate Children Elements: migrated the animation engine from GSAP to Elementor's own bundled animate.css library.
...
* Grew the Text Animation catalog to dozens of GSAP and Anime.js effects, each loaded on demand as its own small chunk.
