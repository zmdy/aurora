			...
			$element->add_control(
				...
				[
					...
					'options'   => [
						...
						'gs-35' => esc_html__( 'Appear Text',     'aurora-for-elementor' ),
					],
					'condition' => [
		...
		$element->add_control(
			...
			[
				...
				'options'   => [
					...
					'ml-53' => esc_html__( 'Appear Text',           'aurora-for-elementor' ),
				],
				'condition' => [
					'aurora_text_enable'  => 'yes',
		...
		$element->add_control(
			...
			[
				...
				'condition' => [
					...
					// isSelfManaged().
					'aurora_text_animation_gsap!' => [ 'gs-3', 'gs-24', 'gs-25', 'gs-26', 'gs-28', 'gs-30', 'gs-32', 'gs-33', 'gs-34', 'gs-35' ],
				],
				'frontend_available' => true,
			]
		);
